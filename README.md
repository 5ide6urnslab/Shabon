...
##### トランジスタについて
トランジスタは熱を持つため、ヒートシンクを付ける事を推奨(放熱接着剤などでヒートシンクを付けば良い)。<br>
https://akizukidenshi.com/catalog/g/gI-08746/

##### 単三電池について
シャボン玉装置に単三電池3本を取り付けて、モーター制御用の電源とする。raspi zeroから電力供給する事も可能であるが、Bluetoothと併せてモーターを動作させるとモーターが数回しか動かす事が出来ない。電流不足になるため、外部電源としての単三電池3本を推奨。
